...
(function () {
    ...
    var wenjuan_url = "https://www.wjx.cn/vm/eBEmrsk.aspx";
    ...
    //1
    console.log(lists);
    console.log(lists[ccc]);
    ops = lists[ccc].querySelectorAll(".ui-radio");
    ccc += 1;
    bili = [55, 45];
    danxuan = randomNum(0, 100);
    if (danxuan >= 45) {
        danxuan = 0;
    } else {
        danxuan = 1;
    ...
    ops = lists[ccc].querySelectorAll(".ui-radio");
    ccc += 1;
    bili = [11, 16, 16, 16, 16, 25];
    danxuan = randomNum(0, 5);
    ops[danxuan].click();
